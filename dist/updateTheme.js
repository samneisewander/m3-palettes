...
import { SchemeContent, SchemeExpressive, SchemeFidelity, SchemeMonochrome, SchemeNeutral, SchemeTonalSpot, SchemeVibrant, } from "@material/material-color-utilities";
 ...
 */
export function updateTheme(primary, scheme, darkMode, contrast) {
    const SchemeObjects = {
